                ...
                FutureBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.data == null) {
                      return const ProgressBar(value: null);
                    } else {
                      return Obx(
                        () => ListView.builder(
                                ...
                                child: material.Ink(
                                  ...
                                  child: material.InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (!await launch(snapshot.data[index])) {
                                    ...
                                    child: ListTile(
                                      ...
                                      trailing: IconButton(
                                        icon: Icon(
                                          // NEW from here...
                                          networkHelper.saved.contains(
                                                  snapshot.data[index])
                                              ? FluentIcons.heart_fill
                                              : FluentIcons.heart,
                                          color: networkHelper.saved.contains(
                                                  snapshot.data[index])
                                              ? Colors.red
                                              : null,
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            if (networkHelper.saved.contains(
                                                snapshot.data[index])) {
                                              networkHelper.saved
